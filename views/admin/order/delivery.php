...
<div uk-grid class="max-height">
  ...
  <div class="uk-width-3-4">
    <h4 class="uk-text-center">Добавить службу доставки</h4><hr class="delimiter green">
    ...
    <div class="uk-flex uk-flex-center">
      <form class="uk-width-1-3@s uk-width-2-3" method="post">
        ...
        <div class="uk-margin">
          <button class="uk-button uk-width-1-1 green-button" name="addDelivery">Добавить</button>
        </div>

      </form>
    </div>

    <h4 class="uk-text-center">Список служб доставок</h4><hr class="delimiter orange">
          ...
          <div>
            <div class="uk-card uk-card-default max-height uk-flex uk-flex-column uk-text-center">
              ...
              <div class="uk-card-footer uk-text-center uk-flex uk-flex-column">
                <a name="edit_show" href="#modal-overflow" data-type="edit_delivery" data-id="<?=$value["number"];?>" uk-toggle class="uk-button uk-button-text">
                  <span uk-icon="icon: pencil;"></span>Редактировать
                </a>
                <a href="/admin/addDelivery/delete/<?=$value["number"]?>" class="uk-margin uk-button uk-button-text">
